// Copyright (c) 2019-2020 The Mocha Core developers
...
static const CRPCCommand commands[] =
    { //  category              name                      actor (function)         okSafe argNames
        //  --------------------- ------------------------  -----------------------  ------ ----------
        { "mocha",               "getpoolinfo",            &getpoolinfo,            true,  {} },
        { "mocha",               "getprivatesendinfo",     &getprivatesendinfo,     true,  {} },
#ifdef ENABLE_WALLET
        { "mocha",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
