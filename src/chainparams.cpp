...
// Copyright (c) 2014-2020 The Mocha Core developers
 ...
 *     CTxIn(COutPoint(000000, -1), coinbase 04ffff001d010420446563656e7472616c697a6174696f6e206973206b6579202d20342f352f3230)
 *     CTxOut(nValue=50.00000000, scriptPubKey=0xA9037BAC7050C479B121CF)
 *   vMerkleTree: e0028e
 */
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    const char* pszTimestamp = "Decentralization is key - 4/16/20";
    const CScript genesisOutputScript = CScript() << ParseHex("042a755d96e0d772a8687d51059705ff47f8056114079e9a7e32d4d9d780ca7014f4794b171f392f05a74947c4a2465271dd8a9d444eba8c2f381f0e4926d42dd0") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nSuperblockStartHash = uint256S("0x00"); // Change when block height is reached
        consensus.nSuperblockCycle = 16616; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
        consensus.nGovernanceMinQuorum = 10;
        consensus.nGovernanceFilterElements = 20000;
        consensus.nMasternodeMinimumConfirmations = 15;
        consensus.BIP34Height = 951;
        consensus.BIP34Hash = uint256S("0x00"); // Change when block height is reached
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1586044800; // 04/05/2020
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1617580800; // 04/05/2021

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1588291200; // 05/01/2020
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1619827200; // 05/01/2021

        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1593561600; // 07/01/2020
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 1625097600; // 07/01/2021
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nThreshold = 3226; // 80% of 4032

        // Deployment of BIP147
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 1598918400; // 09/01/2020
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout = 1630454400; // 09/01/2021
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nThreshold = 3226; // 80% of 4032

        // Deployment of DIP0003
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 1601510400; // 10/01/2020
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nTimeout = 1633046400; // 10/01/2021
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nThreshold = 3226; // 80% of 4032

        // Deployment of DIP0008
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 1609459200; // 01/01/2021
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nTimeout = 1640995200; // 01/01/2022
        ...
        genesis = CreateGenesisBlock(1587939107, 892801, 0x1e0ffff0, 1, 50 * COIN);


        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000006ec565783974791a65ebf8de4a08c42fc6aa45400a82f9e1644474fdab5"));
        ...
        // Mocha script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Mocha private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Mocha BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Mocha BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Mocha BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"Me9NsCwiovsbo2kbuDcGjKWdRzmpN3JM5V"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x000006ec565783974791a65ebf8de4a08c42fc6aa45400a82f9e1644474fdab5")},
            }
        };

        chainTxData = ChainTxData{
            0, // * UNIX timestamp of last known number of transactions (Block 1173619)
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1587939107, 109134, 0x1e0ffff0, 1, 50 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000006e1a54f918f7b1e49d0d8de9d58913f1096ed5542f0d7a9825166b9bdfd"));
        assert(genesis.hashMerkleRoot == uint256S("0xc2f8215a06f8fa3e6ced5a35b4f99aa0140bedfc1d0e355ef826ccec73d60559"));
        ...
        // vSeeds.emplace_back("testnet-seed.mochadot.io", true);

        // Testnet Mocha addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,75);
        // Testnet Mocha script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Mocha BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Mocha BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x000006e1a54f918f7b1e49d0d8de9d58913f1096ed5542f0d7a9825166b9bdfd")},
            }
        };

        chainTxData = ChainTxData{
            0, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000009a50441b5ea08447bb4d67c02faea596641dd4d6efc5df3845f23a60ffb"));
        assert(genesis.hashMerkleRoot == uint256S("0xc2f8215a06f8fa3e6ced5a35b4f99aa0140bedfc1d0e355ef826ccec73d60559"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("-------",  "devnet-seed.mochaevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x000009a50441b5ea08447bb4d67c02faea596641dd4d6efc5df3845f23a60ffb")},
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1587939623, 2488064, 0x1e0ffff0, 1, 50 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000f7cacd92023ebea8723d0bbf58621deee421c830fb95d77e4ef9be790d9"));
        assert(genesis.hashMerkleRoot == uint256S("0xc2f8215a06f8fa3e6ced5a35b4f99aa0140bedfc1d0e355ef826ccec73d60559"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x00000f7cacd92023ebea8723d0bbf58621deee421c830fb95d77e4ef9be790d9")},
            }
        };
        ...
        // Regtest Mocha addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Mocha script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Mocha BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Mocha BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Mocha BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
