...
public:
    CMainParams() {
        ...
        consensus.powLimit = uint256S("003fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x5114fb80e37a3cbf6182c007511ba153bc045519298eb0e26807dafc47cf34d7"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x5114fb80e37a3cbf6182c007511ba153bc045519298eb0e26807dafc47cf34d7")},
            }
        };
...
public:
    CDevNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("mochaevo.org",  "devnet-seed.mochaevo.org"));
