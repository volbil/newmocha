...
/* A AEAD class for ChaCha20-Poly1305@mocha.
 *
 ...
 *
 * The chacha20-poly1305@mocha combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@mocha cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@mocha are relatively fast in
