// Copyright (c) 2018-2019 The Mocha Core developers
...
std::vector<std::pair<arith_uint256, CDeterministicMNCPtr>> CDeterministicMNList::CalculateScores(const uint256& modifier) const
{
    ...
    ForEachMN(true, [&](const CDeterministicMNCPtr& dmn) {
        ...
        // TODO When https://github.com/mocha/mocha/pull/13191 gets backported, implement something that is similar but for single-sha256
        uint256 h;
        CSHA256 sha256;
