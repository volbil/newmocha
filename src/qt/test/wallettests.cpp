...
//
//     src/qt/test/test_mocha-qt -platform xcb      # Linux
//     src/qt/test/test_mocha-qt -platform windows  # Windows
//     src/qt/test/test_mocha-qt -platform cocoa    # macOS
void TestSendCoins()
{
