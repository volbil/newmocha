    ...
    mapper(0)
{
    ...
    ui->mochaAtStartup->setToolTip(ui->mochaAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->mochaAtStartup->setText(ui->mochaAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->mochaAtStartup, OptionsModel::StartAtStartup);
