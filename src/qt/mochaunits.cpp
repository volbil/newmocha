...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case DASH: return QString("Mocha");
            case mDASH: return QString("Milli-Mocha (1 / 1" THIN_SP_UTF8 "000)");
            case uDASH: return QString("Micro-Mocha (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-Mocha (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case DASH: return QString("TestMochas");
            case mDASH: return QString("Milli-TestMocha (1 / 1" THIN_SP_UTF8 "000)");
            case uDASH: return QString("Micro-TestMocha (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-TestMocha (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
