...
QT_TRANSLATE_NOOP("mocha-core", "Mocha Core"),
QT_TRANSLATE_NOOP("mocha-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("mocha-core", ""
"Disable all Mocha specific functionality (Masternodes, PrivateSend, "
...
QT_TRANSLATE_NOOP("mocha-core", ""
"You are starting in lite mode, most Mocha-specific functionality is disabled."),
QT_TRANSLATE_NOOP("mocha-core", ""
"You need to rebuild the database using -reindex to change -timestampindex"),
QT_TRANSLATE_NOOP("mocha-core", ""
"You need to rebuild the database using -reindex to go back to unpruned "
"mode.  This will redownload the entire blockchain"),
QT_TRANSLATE_NOOP("mocha-core", "%d of last 100 blocks have unexpected version"),
QT_TRANSLATE_NOOP("mocha-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("mocha-core", "%s is not a valid backup folder!"),
QT_TRANSLATE_NOOP("mocha-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("mocha-core", "(default: %s)"),
QT_TRANSLATE_NOOP("mocha-core", "(default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "(press q to shutdown and continue later)"),
QT_TRANSLATE_NOOP("mocha-core", "-devnet can only be specified once"),
QT_TRANSLATE_NOOP("mocha-core", "-maxmempool must be at least %d MB"),
QT_TRANSLATE_NOOP("mocha-core", "-port must be specified when -devnet and -listen are specified"),
QT_TRANSLATE_NOOP("mocha-core", "-rpcport must be specified when -devnet and -server are specified"),
...
QT_TRANSLATE_NOOP("mocha-core", "Allow RFC1918 addresses to be relayed and connected to (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Already have that input."),
...
QT_TRANSLATE_NOOP("mocha-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("mocha-core", "Automatic backups disabled"),
...
QT_TRANSLATE_NOOP("mocha-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("mocha-core", "Can't mix while sync in progress."),
QT_TRANSLATE_NOOP("mocha-core", "Can't mix: no compatible inputs found!"),
QT_TRANSLATE_NOOP("mocha-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("mocha-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("mocha-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("mocha-core", "Chain selection options:"),
QT_TRANSLATE_NOOP("mocha-core", "Change index out of range"),
QT_TRANSLATE_NOOP("mocha-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("mocha-core", "Connect through SOCKS5 proxy"),
QT_TRANSLATE_NOOP("mocha-core", "Connect to KeePassHttp on port <port> (default: %u)"),
...
QT_TRANSLATE_NOOP("mocha-core", "Copyright (C)"),
QT_TRANSLATE_NOOP("mocha-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("mocha-core", "Create up to N inputs of each denominated amount (%u-%u, default: %u)"),
...
QT_TRANSLATE_NOOP("mocha-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("mocha-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("mocha-core", "Enable publish hash of governance objects (like proposals) in <address>"),
QT_TRANSLATE_NOOP("mocha-core", "Enable publish hash of governance votes in <address>"),
QT_TRANSLATE_NOOP("mocha-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
...
QT_TRANSLATE_NOOP("mocha-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("mocha-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("mocha-core", "Entries are full."),
QT_TRANSLATE_NOOP("mocha-core", "Entry exceeds maximum size."),
...
QT_TRANSLATE_NOOP("mocha-core", "Error loading %s"),
QT_TRANSLATE_NOOP("mocha-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("mocha-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("mocha-core", "Error loading %s: You can't disable HD on an already existing HD wallet"),
QT_TRANSLATE_NOOP("mocha-core", "Error loading block database"),
QT_TRANSLATE_NOOP("mocha-core", "Error loading wallet %s. -wallet filename must be a regular file."),
QT_TRANSLATE_NOOP("mocha-core", "Error loading wallet %s. Duplicate -wallet filename specified."),
QT_TRANSLATE_NOOP("mocha-core", "Error loading wallet %s. Invalid characters in -wallet filename."),
...
QT_TRANSLATE_NOOP("mocha-core", "Error upgrading chainstate database"),
...
QT_TRANSLATE_NOOP("mocha-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("mocha-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("mocha-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("mocha-core", "Failed to find mixing queue to join"),
QT_TRANSLATE_NOOP("mocha-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("mocha-core", "Failed to load fulfilled requests cache from"),
QT_TRANSLATE_NOOP("mocha-core", "Failed to load governance cache from"),
QT_TRANSLATE_NOOP("mocha-core", "Failed to load masternode cache from"),
QT_TRANSLATE_NOOP("mocha-core", "Failed to load sporks cache from"),
QT_TRANSLATE_NOOP("mocha-core", "Failed to start a new mixing queue"),
QT_TRANSLATE_NOOP("mocha-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("mocha-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("mocha-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("mocha-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("mocha-core", "Importing..."),
QT_TRANSLATE_NOOP("mocha-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("mocha-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("mocha-core", "Incompatible version."),
...
QT_TRANSLATE_NOOP("mocha-core", "Initialization sanity check failed. %s is shutting down."),
QT_TRANSLATE_NOOP("mocha-core", "Input is not valid."),
QT_TRANSLATE_NOOP("mocha-core", "Inputs vs outputs size mismatch."),
QT_TRANSLATE_NOOP("mocha-core", "InstantSend options:"),
QT_TRANSLATE_NOOP("mocha-core", "Insufficient funds."),
QT_TRANSLATE_NOOP("mocha-core", "Invalid -onion address or hostname: '%s'"),
QT_TRANSLATE_NOOP("mocha-core", "Invalid -proxy address or hostname: '%s'"),
QT_TRANSLATE_NOOP("mocha-core", "Invalid amount for -%s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("mocha-core", "Invalid amount for -discardfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("mocha-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("mocha-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("mocha-core", "Invalid masternodeblsprivkey. Please see documentation."),
QT_TRANSLATE_NOOP("mocha-core", "Invalid minimum number of spork signers specified with -minsporkkeys"),
QT_TRANSLATE_NOOP("mocha-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("mocha-core", "Invalid script detected."),
QT_TRANSLATE_NOOP("mocha-core", "Invalid spork address specified with -sporkaddr"),
QT_TRANSLATE_NOOP("mocha-core", "KeePassHttp id for the established association"),
QT_TRANSLATE_NOOP("mocha-core", "KeePassHttp key for AES encrypted communication with KeePass"),
QT_TRANSLATE_NOOP("mocha-core", "Keep N DASH mixed (%u-%u, default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("mocha-core", "Last PrivateSend was too recent."),
QT_TRANSLATE_NOOP("mocha-core", "Last successful PrivateSend action was too recent."),
...
QT_TRANSLATE_NOOP("mocha-core", "Loading P2P addresses..."),
QT_TRANSLATE_NOOP("mocha-core", "Loading banlist..."),
QT_TRANSLATE_NOOP("mocha-core", "Loading block index..."),
QT_TRANSLATE_NOOP("mocha-core", "Loading fulfilled requests cache..."),
QT_TRANSLATE_NOOP("mocha-core", "Loading governance cache..."),
QT_TRANSLATE_NOOP("mocha-core", "Loading masternode cache..."),
QT_TRANSLATE_NOOP("mocha-core", "Loading sporks cache..."),
...
QT_TRANSLATE_NOOP("mocha-core", "Lock is already in place."),
QT_TRANSLATE_NOOP("mocha-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("mocha-core", "Masternode options:"),
QT_TRANSLATE_NOOP("mocha-core", "Masternode queue is full."),
QT_TRANSLATE_NOOP("mocha-core", "Masternode:"),
...
QT_TRANSLATE_NOOP("mocha-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("mocha-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("mocha-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
QT_TRANSLATE_NOOP("mocha-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("mocha-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("mocha-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("mocha-core", "No errors detected."),
QT_TRANSLATE_NOOP("mocha-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("mocha-core", "Node relay options:"),
QT_TRANSLATE_NOOP("mocha-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("mocha-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("mocha-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("mocha-core", "Not enough funds to mix."),
QT_TRANSLATE_NOOP("mocha-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("mocha-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("mocha-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("mocha-core", "Print version and exit"),
QT_TRANSLATE_NOOP("mocha-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("mocha-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("mocha-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("mocha-core", "PrivateSend request incomplete:"),
QT_TRANSLATE_NOOP("mocha-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("mocha-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("mocha-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("mocha-core", "RPC server options:"),
QT_TRANSLATE_NOOP("mocha-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("mocha-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("mocha-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("mocha-core", "Replaying blocks..."),
QT_TRANSLATE_NOOP("mocha-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("mocha-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("mocha-core", "Send trace/debug info to debug.log file (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Session not complete!"),
...
QT_TRANSLATE_NOOP("mocha-core", "Start PrivateSend automatically (0-1, default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Starting network threads..."),
QT_TRANSLATE_NOOP("mocha-core", "Submitted to masternode, waiting in queue %s"),
...
QT_TRANSLATE_NOOP("mocha-core", "Synchronizing blockchain..."),
QT_TRANSLATE_NOOP("mocha-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("mocha-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("mocha-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("mocha-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("mocha-core", "This is experimental software."),
QT_TRANSLATE_NOOP("mocha-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("mocha-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("mocha-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("mocha-core", "Too many %f denominations, skipping."),
...
QT_TRANSLATE_NOOP("mocha-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("mocha-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("mocha-core", "Transaction fee and change calculation failed"),
QT_TRANSLATE_NOOP("mocha-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("mocha-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("mocha-core", "Transaction must have at least one recipient"),
QT_TRANSLATE_NOOP("mocha-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("mocha-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("mocha-core", "Transaction too large"),
QT_TRANSLATE_NOOP("mocha-core", "Trying to connect..."),
QT_TRANSLATE_NOOP("mocha-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("mocha-core", "Unable to bind to %s on this computer. %s is probably already running."),
...
QT_TRANSLATE_NOOP("mocha-core", "Unknown response."),
QT_TRANSLATE_NOOP("mocha-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("mocha-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("mocha-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("mocha-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("mocha-core", "Unsupported logging category %s=%s."),
QT_TRANSLATE_NOOP("mocha-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("mocha-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("mocha-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Use devnet chain with provided name"),
QT_TRANSLATE_NOOP("mocha-core", "Use the test chain"),
...
QT_TRANSLATE_NOOP("mocha-core", "Verifying wallet(s)..."),
QT_TRANSLATE_NOOP("mocha-core", "Very low number of keys left: %d"),
QT_TRANSLATE_NOOP("mocha-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("mocha-core", "Wallet debugging/testing options:"),
QT_TRANSLATE_NOOP("mocha-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("mocha-core", "Wallet needed to be rewritten: restart %s to complete"),
...
QT_TRANSLATE_NOOP("mocha-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("mocha-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("mocha-core", "Whether to operate in a blocks only mode (default: %u)"),
QT_TRANSLATE_NOOP("mocha-core", "Will retry..."),
QT_TRANSLATE_NOOP("mocha-core", "You can not start a masternode in lite mode."),
QT_TRANSLATE_NOOP("mocha-core", "You can not start a masternode with wallet enabled."),
QT_TRANSLATE_NOOP("mocha-core", "You need to rebuild the database using -reindex to change -addressindex"),
QT_TRANSLATE_NOOP("mocha-core", "You need to rebuild the database using -reindex to change -spentindex"),
QT_TRANSLATE_NOOP("mocha-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("mocha-core", "Your entries added successfully."),
...
QT_TRANSLATE_NOOP("mocha-core", "no mixing available."),
QT_TRANSLATE_NOOP("mocha-core", "see debug.log for details."),
};
