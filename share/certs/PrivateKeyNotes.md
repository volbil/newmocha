...
allowing somebody to distribute a Bitcoin-Qt.app or mocha-qt-setup.exe with a valid
...
that the mocha-qt.exe file inside the installer had not been tampered with.
