...
This mechanism has been integrated into Bitcore-Node-Mocha which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mochapay/insight-api-mocha#web-socket-api](https://github.com/mochapay/insight-api-mocha#web-socket-api)
* API: [https://github.com/mochapay/insight-api-mocha#instantsend-transactions](https://github.com/mochapay/insight-api-mocha#instantsend-transactions)
