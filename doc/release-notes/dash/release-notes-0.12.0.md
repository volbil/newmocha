...
Mocha Core version 0.12.0 is now available from:
...
backwards-compatible with pre-0.12 versions of Mocha Core or other software:
...
Switched to Bitcoin Core version 0.10 - https://mocha.org/en/release/v0.10.0
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/mocha/).
