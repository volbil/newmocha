...
Mocha Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- src/libsecp256k1
  - Upstream at https://github.com/mocha-core/secp256k1/ ; actively maintaned by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/mocha-core/ctaes ; actively maintained by Core contributors.
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:mocha/mocha.git
