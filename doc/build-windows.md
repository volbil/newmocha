...
Below are some notes on how to build Mocha Core for Windows.
...
Building on Ubuntu Xenial 16.04 is known to be broken, see extensive discussion in issue [8732](https://github.com/mocha/mocha/issues/8732).
...
way. This will install to `c:\workspace\mocha`, for example:

    make install DESTDIR=/mnt/c/workspace/mocha
