Cross-compiliation of Mocha Core
===============================

Mocha Core can be cross-compiled on Linux to all other supported host systems. This is done by changing
the `HOST` parameter when building the dependencies and then specifying another `--prefix` directory when building Mocha.
...
$ curl https://mochacore.org/depends-sources/sdks/MacOSX10.11.sdk.tar.gz -o depends/sdk-sources/MacOSX10.11.sdk.tar.gz
...
to work around issues with mingw-w64. See issue [8732](https://github.com/mocha/mocha/issues/8732) for more information.
