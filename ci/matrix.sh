...
export BUILDER_IMAGE_NAME="mocha-builder-$BUILD_TARGET-$JOB_NUMBER"
...
export GOAL="install"
export SDK_URL=${SDK_URL:-https://mochacore.org/depends-sources/sdks}
export MAKEJOBS="-j4"
