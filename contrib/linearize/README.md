# Linearize
Construct a linear, no-fork, best version of the Mocha blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install mocha_hash

https://github.com/mochapay/mocha_hash
...
JSON-RPC server. Running `mochad` or `mocha-qt -server` will be sufficient.
...
* `input`: mochad blocks/ directory containing blkNNNNN.dat
